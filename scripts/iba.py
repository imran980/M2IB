...
class IBAInterpreter:
    ...
    def _run_text_training(self, text_t, image_t):
        ...
        text_repr, _ = self.model.get_text_features(text_t, image_repr, output_hidden_states=True)
        cross_attended_text = text_repr
    ...
    def _run_vision_training(self, text_t, image_t):
        text_repr = self.model.get_text_features(text_t)
        image_repr, _ = self.model.get_image_features(image_t, output_hidden_states=True)
        print("within run_vision_training---------------------:")
        print("text_repr---------------------:", text_repr)
        print("image_repr---------------------:", image_repr)
        cross_attended_vision = image_repr
