...
def text_heatmap_iba(text_t, image_t, model, layer_idx, beta, var, lr=1, train_steps=20, progbar=True):
...
def vision_heatmap_iba(text_t, image_t, model, layer_idx, beta, var, lr=1, train_steps=20, progbar=True):
