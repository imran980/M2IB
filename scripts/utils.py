...
class mySequential(nn.Sequential):
    ...
    def forward(self, input_vision, input_text, output_attentions=False, **kwargs):
        vision_repr = self.original_layer(input_vision, output_attentions=output_attentions, **kwargs)
        text_repr = self.original_layer(input_text, output_attentions=output_attentions, **kwargs)
